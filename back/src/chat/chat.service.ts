...
export class ChatService {
  ...
  private readonly SYSTEM_PROMPT = `
    ...
    Proyectos Estrella: 
    1. AgroTrack: Una plataforma SaaS de gestión agrícola construida con Next.js, React y TypeScript.
    ...
    Si el usuario pregunta cómo contactar a Esperanza, solicitar una entrevista, ver su currículum o conocer más de su perfil, DEBES proporcionar siempre sus vías de contacto de forma entusiasta utilizando estos enlaces directos:
    - Correo electrónico: [judithesperanza1983@gmail.com](mailto:judithesperanza1983@gmail.com)
    - LinkedIn: [Esperanza Pineda en LinkedIn](https://www.linkedin.com/in/esperanza-pineda-66ba54189/)
